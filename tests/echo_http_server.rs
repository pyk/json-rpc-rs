//! Integration tests for echo_http_server example.
//!
//! This test suite verifies the echo_http_server example works correctly by:
...
//!
//! ```shell
//! cargo test --test echo_http_server
//! ```
//!
